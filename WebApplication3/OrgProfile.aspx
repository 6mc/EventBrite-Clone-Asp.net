<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgProfile.aspx.cs" Inherits="WebApplication3.OrgProfile" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="White" Height="58px" Width="1377px" style="margin-top: 0px">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/Oprofile.aspx" style="color: #000000">PROFILE</asp:HyperLink>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Panel ID="Panel2" runat="server" BackColor="#3B3B3B" Height="1273px" style="margin-left: 441px; margin-top: 110px" Width="470px">
            <div class="auto-style3" >
                ...
                <br />
                PROFILE<br /> </span>
                <asp:Image ID="Image8" runat="server" Height="131px" ImageUrl="http://job.pharmaglobiz.com/images/default-logo.png" Width="151px" />
                <br />
                <asp:FileUpload ID="FileUpload1" placeholder="upload profile picture" runat="server" style="margin-left: 52px" />
                <br />
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="bilgileri getir" />
                <br />
                <br />
                ...
                <br />
                <br />
                <asp:Image ID="Image10" runat="server" Height="41px" ImageUrl="https://upload.wikimedia.org/wikipedia/commons/7/70/User_icon_BLACK-01.png" Width="45px" />
                <asp:TextBox ID="TextBox7" runat="server" Height="39px" placeholder="Username" style="font-size: x-large; color: #666666;" Width="268px"></asp:TextBox>
                <br />
                <br />
                <br />
                ...
                <asp:TextBox ID="TextBox4" runat="server" Height="39px" placeholder="******" style="font-size: x-large" Width="268px" TextMode="Password"></asp:TextBox>
                <br />
                <br />
                <br />
                <asp:Image ID="Image3" runat="server" Height="41px" ImageUrl="http://pixsector.com/cache/2102b688/av952f32f4fc8384f9336.png" Width="48px" />
                <asp:TextBox ID="TextBox2" runat="server" Height="119px" placeholder="Address" style="font-size: x-large" TextMode="MultiLine" Width="270px"></asp:TextBox>
                <br />
                <br />
                <br />
