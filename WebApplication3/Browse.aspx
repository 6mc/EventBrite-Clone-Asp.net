<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Browse.aspx.cs" Inherits="WebApplication3.Browse" %>
...
<body background="ada.jpg">
    ...
    <div>
        ...
        <asp:Panel ID="Panel3" runat="server" Height="154px" BackColor="White" style="margin-left: 199px; text-align: center;" Width="988px">
            ...
            <asp:Button ID="Button1" runat="server" BackColor="#FF6600" Height="37px" style="color: #FFFFFF; font-size: x-large" Text="SEARCH" Width="149px" />
            <br />
        </asp:Panel>
        ...
        <asp:Panel ID="Panel5" runat="server" BackColor="#F8F8FA" Height="662px">
            <div class="auto-style5">
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Popular Events in</span> <span class="auto-style7">Denizli, Turkey<br />
                <br />
                <asp:Panel ID="Panel8" runat="server" BackColor="White" BorderColor="#333333" BorderStyle="Solid" Height="374px" style="text-align: center; margin-left: 369px; margin-top: 4px" Width="722px">
                    ...
                    <br />
                    <span class="auto-style10">SAT, DEC 24 10:00 PM</span><br /> <span class="auto-style8"><span class="auto-style12">INTERNATIONAL MOBILE GAMING AWARDS</span><span class="auto-style7"><br />
                    <br />
